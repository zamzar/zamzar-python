...
class Failure(BaseModel):
    ...
    """ # noqa: E501
    code: Optional[StrictInt] = Field(default=None, description="Can be used to determine what action to take")
    message: Optional[StrictStr] = Field(default=None, description="Provides an explanation of the failure (which could also be displayed to your users)")
