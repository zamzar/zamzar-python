...
class Export(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier assigned to the export")
    url: Optional[StrictStr] = Field(default=None, description="The URL of the resulting (exported) file")
    status: Optional[StrictStr] = Field(default=None, description="The current status of the export", json_schema_extra={"examples": ["successful"]})
    failure: Optional[Failure] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "url", "status", "failure"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['initialising', 'uploading', 'successful', 'failed']):
            raise ValueError("must be one of enum values ('initialising', 'uploading', 'successful', 'failed')")
        return value
