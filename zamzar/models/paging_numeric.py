...
class PagingNumeric(BaseModel):
    """
    PagingNumeric
    """ # noqa: E501
    total_count: Optional[StrictInt] = Field(default=None, description="The number of elements in the entire collection")
    first: Optional[StrictInt] = Field(default=None, description="The identifier of the first element in this page of the collection")
    last: Optional[StrictInt] = Field(default=None, description="The identifier of the last element in this page of the collection")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PagingNumeric from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PagingNumeric from a dict"""
        if obj is None:
            return None
