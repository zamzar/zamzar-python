...
class WelcomeApi:
    ...
    def welcome(
        ...
        _param = self._welcome_serialize(
    ...
    def welcome_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[Welcome200Response]:
        """Welcome
    ...
    @validate_call
    def welcome_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
