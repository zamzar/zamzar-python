...
from zamzar_sdk.api_response import ApiResponse, T as ApiResponseT
import zamzar_sdk.models
from zamzar_sdk import rest
from zamzar_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'zamzar-python-v1'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(zamzar_sdk.models, klass)
