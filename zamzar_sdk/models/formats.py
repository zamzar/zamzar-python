...
class Formats(BaseModel):
    ...
    """ # noqa: E501
    paging: Optional[PagingString] = None
    data: Optional[List[Format]] = Field(default=None, description="An array of source and target formats ordered alphabetically.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "paging": PagingString.from_dict(obj["paging"]) if obj.get("paging") is not None else None,
            "data": [Format.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
